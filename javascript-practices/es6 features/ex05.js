...
const goods1 = {
    name: 'TV', price: 1000, countStock: 10
}
const goods2 = {
    name: 'TV', price: 2000, countSold: 20
}
const goods3 = {
    name: 'TV', price: 1000,
}

const printGoods = ({name, price, countStock = 0, countSold = 0}) => {
...
const printPerson = ({n: name, c: country}) => {
...
const student = {
    email: 'dooly@gmail.com', score: {
        math: 30, korean: 100, science: 60
    }
}
...
const avgScore = ({
                      email, score: {math, korean, science, music = 0}
...
const printColor = function () {
    Array.from(arguments).forEach((color) => console.log(color));
};
